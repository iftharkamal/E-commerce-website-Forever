      ...
      {/* ------------Product Data------------- */}
        <div className='flex flex-col gap-12 sm:flex-row sm:gap-12'>
          ...
          <div className='flex-1'>
              ...
              <div className='text-sm text-gray-500 mt-5 flex flex-col gap-1'>
                  ...
                  <p>Cash onD Delivery available on this product.</p>
        ...
        <div className='mt-20'>
            ...
            <div className='flex flex-col gap-4 text-sm border px-6 py-6 text-gray-500'>
               ...
               <p>E-commerce websites typically displays products or services along with detailed descriptions, images, prices, and any available variations (e.g., sizes, colors).Each product usually has its own dedicated pages with relevant informations.</p>
            </div>
        </div>
